    ...
    <Modal open onClose={onClose} title="Generate Invoice">
      <div className="space-y-4 p-1">
        ...
        <div className="bg-blue-50 rounded-lg p-3 text-sm text-blue-800 space-y-1">
          ...
          <p className="text-blue-600">{clientDisplayName(job.client)}</p>
...
export default function InvoicesPage() {
  ...
  // Build invoice map by jobId for quick lookup
  ...
  // Apply status filter across all rows
  ...
  // Summary stats from all completed jobs
      ...
      <div className="flex items-center justify-between gap-4 flex-wrap">
        ...
        {noInvoiceCount > 0 && (
          <div className="flex items-center gap-2 bg-amber-50 border border-amber-200 rounded-lg px-3 py-2 text-sm text-amber-800">
            ...
            {noInvoiceCount} completed job{noInvoiceCount !== 1 ? "s" : ""} without an invoice
          </div>
        )}
      </div>
                  ...
                  <div className="flex items-center gap-6">
                    <div className="text-right hidden sm:block">
                      ...
                      <p className="text-sm font-semibold text-gray-900">
                        ...
                        {groupOwed > 0 && (
                          <span className="text-amber-600"> · {formatCurrency(groupOwed)} due</span>
                        )}
                        {groupOwed === 0 && groupTotal > 0 && (
                            ...
                            >
                              ...
                              <td className="px-5 py-3">
                                {noInv ? (
                                  ...
                                  <span className={cn(
                                    ...
                                    INVOICE_STATUS_COLOR[inv.status as InvoiceStatus]
                                  )}>
                                    {inv.status}
                                  </span>
                                )}
                              ...
                              <td className="px-5 py-3">
                                <div className="flex items-center gap-1 justify-end">
                                  {/* Generate invoice for jobs with no invoice or only a draft */}
                                  {needsAction && (
                                    <Button
                                      size="sm"
                                      variant="ghost"

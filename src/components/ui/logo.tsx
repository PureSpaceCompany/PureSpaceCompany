...
export function Logo({ size = "md", variant = "light", className }: LogoProps) {
  ...
  return (
    <div className={cn("flex items-center gap-2.5", className)}>
      ...
      >
        {/* Outer glow ring */}
        <circle cx="20" cy="20" r="19" fill="url(#logoGradient)" opacity="0.15" />
        ...
        <path d="M32 8 L33 6 L34 8 L36 9 L34 10 L33 12 L32 10 L30 9 Z" fill="#f0abfc" opacity="0.9" />
      </svg>

      {/* Wordmark */}
      <span className={cn("font-bold tracking-tight", textSize, textColor)}>
        Stay<span className="text-sky-400">Shine</span>
      </span>
    </div>
  );
}
